...
function SignupFormDemo() {
  ...
  return (
    <div className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 md:shadow-[0px_5px_0px_5px_#00f7d6_inset,0px_-5px_0px_-5px_#00f7d6_inset] shadow-input bg-black dark:bg-black md:mt-16 mt-8  ">
      ...
      <p className="text-neutral-600 text-sm max-w-sm mt-2 dark:text-neutral-300 text-white">
        ...
        <Link href="/login" className="text-[#00f7d6] font-semibold">
          Login
        </Link>
      </p>

      <form className="my-8" onSubmit={handleSubmit}>
        <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 mb-4 text-[#00f7d6]">
          <LabelInputContainer>
